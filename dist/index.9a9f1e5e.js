...
})({"jBXRr":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
...
},{"./components/todos":"cvDxX"}],"cvDxX":[function(require,module,exports) {
var _api = require("../../api");
var _helpers = require("../../helpers");
var _refs = require("../../refs");
_api.getPosts().then(_helpers.draw);
_refs.refs.form.addEventListener("submit", async (event)=>{
    event.preventDefault();
    const formData = new FormData(event.target);
    formData.forEach((value, name)=>{
        post[name] = value;
    });
    await _api.addPost(post);
    const allPosts = await _api.getPosts();
    _helpers.draw(allPosts);
});
_refs.refs.list.addEventListener("click", async (event)=>{
...
},{"../../api":"gHpxQ","../../helpers":"kEqbI","../../refs":"hMwwV"}],"gHpxQ":[function(require,module,exports) {
...
_axiosDefault.default.defaults.baseURL = "https://628511c03060bbd347441aa3.mockapi.io/";
const getPosts = async ()=>{
    try {
        const { data  } = await _axiosDefault.default.get("posts");
        return data;
    } catch (error) {
...
const deletePost = async (id)=>{
    try {
        const { data  } = await _axiosDefault.default.delete(`posts/${id}`);
        return data;
    } catch (error) {
        throw new Error(`что-то пошло не так ${error}`);
    }
...
const addPost = async (post)=>{
    try {
        const { data  } = await _axiosDefault.default.post(`posts`, post);
        return data;
    } catch (error) {
        throw new Error(`что-то пошло не так ${error}`);
    }
...
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "drawTemplate", ()=>drawTemplate
);
...
const draw = (posts)=>{
    ...
    _refs.refs.list.innerHTML = template;
};

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","../refs":"hMwwV"}],"hMwwV":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["jBXRr","5f1PK"], "5f1PK", "parcelRequire8cbc")

//# sourceMappingURL=index.9a9f1e5e.js.map
