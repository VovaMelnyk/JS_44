...
const drawTemplate = (posts)=>{
    const template = posts?.reduce((acc, post1)=>{
        return acc += `<li data-id=${post1.id}><p>${post1.post}</p><button>delete</button></li>`;
    }, "");
...
const getPosts = ()=>{
    _axiosDefault.default("posts").then((res)=>{
...
const deletePost = (id)=>{
    _axiosDefault.default.delete(`https://628511c03060bbd347441aa3.mockapi.io/posts/${id}`).then((data)=>{
...
const addPost = (post2)=>{
    ...
    _axiosDefault.default.post("https://628511c03060bbd347441aa3.mockapi.io/posts", post2).then(()=>{
...
},{}]},["7fmqN","8lqZg"], "8lqZg", "parcelRequire8cbc")
